...
<body>
        ...
        <section id="home" class="page-type black-bg font-white depth-type animated delayed no-opacity" data-animation="fadeIn" data-animation-delay="0s">
        	<div class="container">
        		<div class="row"> <!-- style="padding-bottom: 425px;"-->
        			<div class="col-md-arize col-xs-12 col-sm-12 text-left">

        				<!-- logo -->
        				<div class="big-logo animated delayed no-opacity" data-animation="fadeInDown" data-animation-delay="0.4s"><a href="#" data-toggle="modal" data-target="#logostory"><img src="uploads/logo 222.png" style="width: 25%" alt="arise-logo" /></a></div>
                ...
                <div class="owl-carousel depth-slider">
                    <?php if(!empty($carousel)) { ?>
						<?php for($i=0;$i<sizeof($carousel);$i++) { ?>
							<div class=""><img class="img-responsive" src="uploads/carousel/<?php echo $carousel[$i]['name']; ?>" alt="<?php echo $carousel[$i]['name']; ?>" /></div>							
						<?php } ?>
					<?php } ?>
                </div>
        	...
        	<div class="container no-padding-bottom">
            	<div class="row">
                	<div class="col-md-12 text-center">
                    	<h1 class=" no-margin-bottom" style="padding-top: 100px; color: #e6007e; font-family: AriseFont;">Extraordinary Is Our Ordinary</h1>
        ...
        <aside id="parallax-one" class="separator-type" style="/*height: 600px;*/">
            ...
            <div id="parallax-cta" class="parallax texture" style="width: 100%; height: auto; background-image:url(uploads/_MG_7889.jpg); background-repeat: no-repeat;
    background-size: contain;"></div>
        ...
        <section id="portfolio" class="page-type grey-bg">
        	<div class="container">
        		<div class="row">
        			<div class="col-md-12">
        				<h1 class="section-title text-center" style="font-family: AriseFont;">Services</h1>
    ...
    height: auto; background-image:url(uploads/IMG_0457.jpg); background-repeat: no-repeat;
    background-size: contain;"></div>
        	...
        	<div class="container">
        		...
        		<div class="row">
        			<div class="col-md-4">
						...
						<br><?php language('mobile').language('-'); ?>(+20)<?php language(' '); ?><?php echo $contact['mobile']; ?>
						<br><?php language('phone').language('-'); ?>(+20)<?php language(' '); ?><?php echo $contact['phone']; ?>
						<br><?php language('sphone').language('-'); ?>(+20)<?php language(' '); ?><?php echo $contact['sphone']; ?>
        			...
        			<div class="col-md-4">
        				<h3 class="no-margin-top" style="font-family: AriseFont;">Form</h3>

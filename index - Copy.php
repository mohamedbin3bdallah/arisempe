...
<body>
	        	...
	        	<div class="container">
	            	<div class="row">
	                	<div class="col-md-12 clearfix">
	                    	<div class="logo pull-left"><a href="index.html"><img src="uploads/logo.png" alt="arise-logo" /></a></div>
        ...
        <section id="home" class="page-type black-bg font-white depth-type animated delayed no-opacity" data-animation="fadeIn" data-animation-delay="0s">
        	<div class="container">
        		<div class="row" style="padding-bottom: 265px;">
        			<div class="col-md-12 text-center">

        				<!-- logo -->
        				<div class="big-logo animated delayed no-opacity" data-animation="fadeInDown" data-animation-delay="0.4s"><img src="uploads/logo 222.png" width="300" alt="arise-logo" /></div>
            ...
            <div class="depth-bg">			
            	...
            	<div class="depth-bg-img" style="background-image: url(demo/bg/home-bg.png);"></div>
        ...
        <section id="about-us" class="page-type">
        	<div class="container no-padding-bottom">
            	<div class="row">
                	<div class="col-md-12 text-center">
                    	<h1 class="section-title no-margin-bottom">We Love Design</h1>
                ...
                <div class="row text-center">
                    <div class="col-md-3">
                        <div class="service bottom-arrow clearfix animated delayed no-opacity" data-animation="fadeInLeft" data-animation-delay="0.2s">
                            <div class="shape diamond center dark shape-icon"><a href="#" data-toggle="modal" data-target="#body"><i class="fa fa-adjust fa-fw"></i></a></div>
                    ...
                    <div class="col-md-3">
                        <div class="service bottom-arrow clearfix animated delayed no-opacity" data-animation="fadeInLeft" data-animation-delay="0.4s">
                            <div class="shape diamond center dark shape-icon"><a href="#" data-toggle="modal" data-target="#vision"><i class="fa fa-flask fa-fw"></i></a></div>
                    ...
                    <div class="col-md-3">
                        <div class="service bottom-arrow clearfix animated delayed no-opacity" data-animation="fadeInRight" data-animation-delay="0.6s">
                            <div class="shape diamond center dark shape-icon"><a href="#" data-toggle="modal" data-target="#mission"><i class="fa fa-mobile fa-fw"></i></a></div>
                    ...
                    <div class="col-md-3">
                        <div class="service bottom-arrow clearfix animated delayed no-opacity" data-animation="fadeInRight" data-animation-delay="0.8s">
                            <div class="shape diamond center dark shape-icon"><a href="#" data-toggle="modal" data-target="#values"><i class="fa fa-eye fa-fw"></i></a></div>
        ...
        <aside id="parallax-one" class="separator-type">

            <div class="container text-center">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <p class="tagline">Vinto is a clean, modern theme with a vintage touch</p>
                        <a href="#" class="btn btn-border border-white">Read More</a>
                    </div>
                </div>
            </div>

            <!-- parallax with texture -->
            <div id="parallax-cta" class="parallax texture" style="background-image:url(http://placehold.it/1900x1050);"></div>
        					...
        					<ul class="slides">
								<?php for($i=0;$i<sizeof($subcategories);$i++) { ?>
									<?php if(!empty($subcategories)) { ?>
										<li class="shape diamond" data-category="<?php echo $subcategories[$i]['categoryid']; ?>">
											<a class="item-hover ajax-nav" href="#!portfolio-item/services.php?title=<?php echo $subcategories[$i]['title']; ?>"><span class="hover-title special-font"><?php echo $subcategories[$i]['title']; ?></span><span class="hover-action">- view -</span></a>
        ...
        <!-- Begin Separator Aside -->
        <aside id="contact-cta" class="separator-type">

            <div class="container text-center">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <p class="tagline">Interested in our services?</p>
                        <a href="#" class="btn btn-border border-white">Contact Us</a>
                    </div>
                </div>
            </div>

            <!-- parallax with texture -->
            <div id="parallax-contact" class="parallax texture" style="background-image:url(http://placehold.it/1900x1050);"></div>
        ...
        <!-- Begin Contact -->
		<?php if(!empty($contact)) { ?>
        <section id="contact" class="page-type black-bg font-white">
        	<div class="container">
        		<div class="row text-center">
        			<div class="col-md-12">
        				<h1 class="section-title"><?php language('contact'); ?></h1>
        			</div>
        		</div>
        		<div class="row">
        			<div class="col-md-4">
						...
						<br><?php language('mobile').language('-'); ?><?php echo $contact['mobile']; ?><?php language(' ').language('phone').language('-'); ?><?php echo $contact['phone']; ?><?php language(' ').language('sphone').language('-'); ?><?php echo $contact['sphone']; ?>
        				<br><a href="#"><?php echo $contact['email']; ?></a></p>
        ...
        <footer id="footer" class="footer-type">
        	<div class="container text-center">
        	<p class="copyright no-margin-bottom">&copy; 2014 Vinto. All rights reserved. Designed and developed by <a href="#">ThemeShifters</a></p>
        	</div>
        </footer>
        <!-- // End Footer -->
